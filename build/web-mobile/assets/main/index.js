...
System.register("chunks:///_virtual/Building.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ResourceManager.ts', './SharedDefines.ts', './BuildDataManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, EventTarget, Sprite, UITransform, BoxCollider2D, Component, SpriteFrame, ResourceManager, BuildingType, SceneItemState, SharedDefines, BuildDataManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BuildingPlacementComponent.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SharedDefines.ts', './ResourceManager.ts', './Building.ts', './NetworkManager.ts', './SpriteHelper.ts'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, RigidBody2D, Collider2D, Contact2DType, Color, Director, Camera, Sprite, Vec3, SpriteFrame, UITransform, BoxCollider2D, Component, SharedDefines, ResourceManager, Building, NetworkManager, SpriteHelper;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
      ...
      var BuildingPlacementComponent = exports('BuildingPlacementComponent', (_dec = ccclass('BuildingPlacementComponent'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.placeBuilding = /*#__PURE__*/function () {
          var _placeBuilding = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(callback) {
            var buildingComponent, buildingContainer, result;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                ...
                case 11:
                  _context.next = 13;
                  return NetworkManager.instance.addBuilding(this.buildData.id, this.node.getWorldPosition().x, this.node.getWorldPosition().y, buildingContainer.name);
                case 13:
                  result = _context.sent;
...
System.register("chunks:///_virtual/DashFunManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './NetworkManager.ts'], function (exports) {
  var _inheritsLoose, _createClass, _assertThisInitialized, cclegacy, _decorator, EventTarget, Component, NetworkManager;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _createClass = module.createClass;
        ...
        */;
        ...
        _proto.onMessage = function onMessage(event) {
          ...
          if (dashfun.method == DashFunManager.EVENT_OPEN_INVOICE_RESULT) {
            var _dashfun$result$data = dashfun.result.data,
              paymentId = _dashfun$result$data.paymentId,
              status = _dashfun$result$data.status;
...
System.register("chunks:///_virtual/Fence.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Animal.ts', './ResourceManager.ts', './SharedDefines.ts', './WindowManager.ts', './CooldownComponent.ts', './NetworkManager.ts', './SceneEntity.ts', './PlayerController.ts', './UIEffectHelper.ts', './CoinCollectionEffectComponent.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createForOfIteratorHelperLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, EventTarget, Director, UITransform, Vec3, Vec2, Rect, instantiate, Animal, ResourceManager, SharedDefines, FarmSelectionType, SceneItemType, CommandType, WindowManager, CooldownComponent, NetworkManager, SceneEntity, PlayerController, UIEffectHelper, CoinType;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      var Fence = exports('Fence', (_dec = ccclass('Fence'), _dec(_class = (_class2 = /*#__PURE__*/function (_SceneEntity) {
        ...
        _proto.onDrop = function onDrop(draggable) {
          ...
          if (draggable instanceof Animal) {
            ...
            NetworkManager.instance.plant(animal.id, SceneItemType.Animal, worldPos.x, worldPos.y, this.node.name);
            this.cooldownComponent.startCooldown('select', SharedDefines.COOLDOWN_SELECTION_TIME, function () {});
          }
        }
        //#endregion
...
System.register("chunks:///_virtual/GameController.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './PlotTile.ts', './PlayerController.ts', './SharedDefines.ts', './CropDataManager.ts', './ItemDataManager.ts', './BuildDataManager.ts', './AnimalDataManager.ts', './Fence.ts', './Animal.ts', './NetworkManager.ts', './ResourceManager.ts', './Crop.ts', './Building.ts', './InventoryComponent.ts', './PlayerState.ts', './SyntheDataManager.ts', './GradeDataManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, _asyncToGenerator, _regeneratorRuntime, _createForOfIteratorHelperLoose, cclegacy, _decorator, Prefab, Node, EventTarget, instantiate, Component, Vec3, Layers, PlotTile, PlayerController, SharedDefines, SceneItemType, CropDataManager, ItemDataManager, BuildDataManager, AnimalDataManager, Fence, Animal, NetworkManager, ResourceManager, Crop, Building, InventoryItem, PlayerState, SyntheDataManager, GradeDataManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var GameController = exports('GameController', (_dec = ccclass('GameController'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function GameController() {
          ...
          _this = _Component.call.apply(_Component, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "playerControllerPrefab", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "gameplayContainer", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "friendGameplayContainer", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "buildingContainer", _descriptor4, _assertThisInitialized(_this));
              ...
              while (1) switch (_context6.prev = _context6.next) {
                ...
                case 19:
                  ...
                  _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
                    ...
                    var item, node, component, plotTile;
      ...
      }(Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "playerControllerPrefab", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "gameplayContainer", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "friendGameplayContainer", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "buildingContainer", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/GameWindow.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ResourceManager.ts', './SharedDefines.ts', './WindowBase.ts', './CropDataManager.ts', './SpriteHelper.ts', './WindowManager.ts', './CoinDisplay.ts', './DiamondDisplay.ts', './NetworkManager.ts', './DashFunManager.ts', './GradeDataManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Label, ProgressBar, ScrollView, Node, Button, Sprite, Color, Layout, instantiate, SpriteFrame, ResourceManager, SharedDefines, WindowBase, CropDataManager, SpriteHelper, WindowManager, CoinDisplay, DiamondDisplay, NetworkManager, DashFunManager, GradeDataManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/LayoutAdapter.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var LayoutAdapter = exports('LayoutAdapter', (_dec = ccclass('LayoutAdapter'), _dec2 = property(Boolean), _dec3 = property(Boolean), _dec4 = property(Layout), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function LayoutAdapter() {
          ...
          _this = _Component.call.apply(_Component, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "adapterWidth", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "adapterHeight", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "_layout", _descriptor3, _assertThisInitialized(_this));
      ...
      }(Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "adapterWidth", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "adapterHeight", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "_layout", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './GameEntry.ts', './BuildingPlacementComponent.ts', './CooldownComponent.ts', './DragDropComponent.ts', './InputComonent.ts', './InventoryComponent.ts', './GameController.ts', './PlayerController.ts', './CoinCollectionEffectComponent.ts', './Animal.ts', './Building.ts', './Crop.ts', './Fence.ts', './GrowthableEntity.ts', './PlayerState.ts', './PlotTile.ts', './SceneEntity.ts', './DateHelper.ts', './HttpHelper.ts', './SpriteHelper.ts', './UIEffectHelper.ts', './UIHelper.ts', './AnimalDataManager.ts', './BuildDataManager.ts', './BuildingManager.ts', './CropDataManager.ts', './DashFunManager.ts', './GradeDataManager.ts', './ItemDataManager.ts', './NetworkManager.ts', './ResourceManager.ts', './SyntheDataManager.ts', './SharedDefines.ts', './NetworkPlayerState.ts', './UIAdaptComponent.ts', './WindowManager.ts', './WindowBase.ts', './CoinDisplay.ts', './CurrencyDisplayBase.ts', './DiamondDisplay.ts', './LayoutAdapter.ts', './CraftScrollViewItem.ts', './ScrollViewItem.ts', './CraftWindow.ts', './FarmFactoryWindow.ts', './FarmSelectionWindow.ts', './GameWindow.ts', './MainWindow.ts', './ShopWindow.ts', './TipsWindow.ts', './ToastWindow.ts'], function () {
  return {
    setters: [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
    execute: function () {}
  };
});
...
System.register("chunks:///_virtual/MainWindow.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './WindowBase.ts', './WindowManager.ts', './NetworkManager.ts', './DashFunManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, EditBox, Button, WindowBase, WindowManager, NetworkManager, DashFunManager, PayItemType;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      var PlotTile = exports('PlotTile', (_dec = ccclass('PlotTile'), _dec2 = property(Vec2), _dec(_class = (_class2 = (_class3 = /*#__PURE__*/function (_SceneEntity) {
        ...
        _proto.onDrop = function onDrop(draggable) {
          ...
          if (draggable instanceof Crop) {
            ...
            NetworkManager.instance.plant(crop.id, SceneItemType.Crop, worldPos.x, worldPos.y, this.node.name);
          }
        };
...
System.register("chunks:///_virtual/UIAdaptComponent.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, screen, view, ResolutionPolicy, Component;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/WindowBase.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameController.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, Vec3, director, Tween, Component, GameController;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
