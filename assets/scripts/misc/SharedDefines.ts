...
export class SharedDefines {
    ...
    public static readonly DESIGN_RESOLUTION_WIDTH: number = 1920;
    public static readonly DESIGN_RESOLUTION_HEIGHT: number = 1080;
    ...
    public static readonly PATH_GAMEPLAY_CANVAS: string = 'GameplayCanvas';
    ...
    public static readonly EVENT_PLAY_EXP_EFFECT: string = 'play-exp-effect';
    ...
    public static readonly WINDOW_TIPS_NAME: string = "TipsWindow";
