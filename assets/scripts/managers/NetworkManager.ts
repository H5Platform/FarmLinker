...
export class NetworkManager extends Component {
    ...
    public static readonly API_ADD_DIAMOND: string = "/payment/addDiamond";
    ...
    private get baseUrl(): string {
        ...
        if (BUILD) {
            return "https://server-test.farmslinker.com";//"https://server-test.farmslinker.com";//"https://farmlinker-tma-test.dashfun.games";//this.serverBaseUrl;
        } else {
    ...
    public async requestAddDiamondForTest(amount: number): Promise<NetworkAddDiamondResult> {
        ...
        const url = this.buildApiUrl(NetworkManager.API_ADD_DIAMOND, this.paymentPort);
        const headers = {
            'Authorization': this.token,
            ...this.defaultHeaders
        };
